                        ...
                        <div className="w-full lg:w-1/2 px-4 mb-0 flex items-center">
                            <div className="w-full text-center lg:text-left">
                                <div className="mx-auto mb-6 lg:mx-0">
                                    ...
                                    <p className="text-base lg:text-lg font-roboto wow animate__ animate__fadeInUp animated animated visible text-gray-500">As a software developer with focus on PHP, JavaScript, and Python. My main expertise is creating apps, especially web apps. I'm also an eager learner and adaptive to the latest technologies.</p>
                                </div>
                                <div className="mx-auto mb-6 lg:mx-0">
